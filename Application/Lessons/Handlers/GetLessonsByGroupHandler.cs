...
{
	public class GetLessonsByGroupHandler : IRequestHandler<GetLessonsByGroupRequest, GetLessonsByGroupResponse>
	{
		...
		public GetLessonsByGroupHandler(IApplicationDbContext appDbContext, IMapper mapper)
		{
